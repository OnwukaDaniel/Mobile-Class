...
class AClass : FragmentActivity(), View.OnClickListener {
    ...
    private fun viewPager() {
        ...
        viewPagerAdapter.dataset = arrayListOf(StudentFragment(), LessonsFragment(classInfo), Assignments())
    ...
    inner class ViewPagerAdapter(fa: FragmentActivity) : FragmentStateAdapter(fa) {
        var dataset: ArrayList<Fragment> =
            arrayListOf(StudentFragment(), LessonsFragment(classInfo), Assignments())
